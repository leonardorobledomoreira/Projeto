...
chatbot:-
   %Base de dados 1.
    format('Seja bem-vindo, para realizar sua pesquisa, digite o número da pergunta que deseja fazer.'),nl,
   ...
   %Base de dados 2.
    ...
    format('29- Quais são os protocolos que constituem o TCP?”, “O que é IGRP?'),nl,
